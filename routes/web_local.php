...
Route::post('/painel_de_controle/admin/empresa_criar', 'AdminController@empresa_criar');
Route::any('/painel_de_controle/admin/{id}/empresa_editar', 'AdminController@empresa_editar');
Route::patch('/painel_de_controle/admin/{id}/empresa_salvar', 'AdminController@empresa_salvar');
Route::any('/painel_de_controle/admin/{id}/empresa_confirmar_deletar', 'AdminController@empresa_confirmar_deletar');
Route::delete('/painel_de_controle/admin/{id}/empresa_deletar', 'AdminController@empresa_deletar');
Route::get('/painel_de_controle/admin/{id}/empresa_estatisticas', 'AdminController@empresa_estatisticas');
...
Route::get('/painel_de_controle/admin/{id}/departamento_estatisticas', 'AdminController@departamento_estatisticas');
...
Route::get('/painel_de_controle/admin/{id}/eventos_por_empresa', 'AdminController@eventos_por_empresa');
...
Route::any('/painel_de_controle/admin/{id}/cliente_salvar_dado_especifico', 'AdminController@cliente_salvar_dado_especifico');
Route::any('/painel_de_controle/admin/{id}/cliente_salvar_dados_especificos', 'AdminController@cliente_salvar_dados_especificos');
...
//admin/pesquisa
Route::any('/painel_de_controle/admin/pesquisar', 'AdminController@pesquisar');
...
Route::any('painel_de_controle/admin/{id}/feedback_resposta_editar', 'AdminController@feedback_resposta_editar');
Route::any('painel_de_controle/admin/{id}/feedback_resposta_atualizar', 'AdminController@feedback_resposta_atualizar');
Route::post('painel_de_controle/admin/{id}/feedback_resposta_confirmar_deletar', 'AdminController@feedback_resposta_confirmar_deletar');
Route::any('painel_de_controle/admin/{id}/feedback_resposta_deletar', 'AdminController@feedback_resposta_deletar');
...
Route::post('painel_de_controle/admin/{id}/resposta_feedback_confirmar_deletar', 'AdminController@resposta_feedback_confirmar_deletar');
...
Route::any('/painel_de_controle/admin/{id}/ramal_aviso_deletar', 'RamalController@ramal_aviso_deletar');
...
Route::any('/painel_de_controle/usuarios/{id}/cliente_salvar_dado_especifico', 'UserController@cliente_salvar_dado_especifico');
...
//usuarios/pesquisa
Route::any('/painel_de_controle/usuarios/pesquisar', 'UserController@pesquisar');
...
Route::any('/painel_de_controle/usuarios/admin_pesquisar_ramal', 'UserController@admin_pesquisar_ramal');
