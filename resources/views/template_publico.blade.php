	...
	<div class="menu_container text-right">
		...
		<nav class="menu_nav">
			<ul>
				...
				<li><a href="\ramais/cadastro">Cadastro</a></li>
			...
			<div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
				<nav class="main_nav">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						...
						<li><a target="_blank" href="http://atdigital.com.br/assinatura/">Assinatura</a></li>
						<li><a href="\ramais/faq">Como utilizar o aparelho</a></li>
						<li><a href="\ramais/cadastro">Cadastrar</a></li>
					</ul>
				</nav>
				<div class="add_listing text-center trans_200"><a href="\ramais/login">Login</a></div>
				<div class="hamburger">
											...
											<div class="search_form_container">
												...
												<form action="\ramais/pesquisar" class="search_form" id="search_form">
													<div class="d-flex flex-sm-row flex-column align-items-sm-start align-items-center justify-content-sm-between">
														...
														<input type="text" class="search_input shadow-sm p-3 mb-5 bg-white rounded" placeholder="Digite o ramal que você procura" id="pesquisar_publico" value name="pesquisar_publico">
						...
						<div class="footer_container d-flex flex-md-row flex-column align-items-center justify-content-md-start justify-content-center">
							...
							<nav class="footer_nav ml-md-auto order-md-2 order-1">
								<ul class="d-flex flex-row align-items-center justify-content-start">
									...
									<li><a href="\ramais/login">Login</a></li>
									<li><a href="\ramais/cadastro">Cadastrar</a></li>
								</ul>
							</nav>
						</div>
