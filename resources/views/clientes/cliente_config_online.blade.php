@include('clientes.clientes_sidebar');
 ...
 <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <div class="margem_cima_baixo">
           ...
           @if(Request::is('painel_de_controle/clientes/*/config_edit'))

             {!! Form::model('$user',['method' => 'PATCH', 'url' => 'http://atdigital.com.br/cadastro/painel_de_controle/clientes/'.$user['id'].'/config_atualizar']) !!}
