...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="/painel_de_controle/usuarios/">GRUPO<strong>TRIBUNA</strong></a>
      ...
      <ul class="navbar-nav ml-auto ml-md-0">
        <li class="nav-item dropdown no-arrow mx-1">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="messagesDropdown">
            <a class="dropdown-item" href="\painel_de_controle/usuarios/feedback">Ver Mensagens</a>
          </div>
        </li>
        <li class="nav-item dropdown no-arrow">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
            <a class="dropdown-item" href="\painel_de_controle/usuarios/config">Configurações</a>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="/painel_de_controle/usuarios/">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/painel_de_controle/usuarios/config">
            <span data-feather="settings"></span>
            <span>Configurações</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/painel_de_controle/usuarios/eventos">
            <span data-feather="activity"></span>
            <span>Eventos</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/painel_de_controle/usuarios/campos_adicionais">
            <span data-feather="folder-plus"></span
            <span>Campos Adicionais</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/painel_de_controle/usuarios/clientes">
            <span data-feather="users"></span>
            <span>Clientes</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/painel_de_controle/usuarios/feedback">
            <span data-feather="file-text"></span>
            <span>Feedback</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/painel_de_controle/usuarios/ramais">
            <span data-feather="phone"></span>
            <span>Ramais</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/painel_de_controle/usuarios/setores">
