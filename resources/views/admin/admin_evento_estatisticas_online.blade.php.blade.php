              ...
              <div class="row">
                @foreach($evento as $campo)
                 ...
                 @endforeach
                  ...
                  <div class="col-sm-8"> 
                    <a href=/cadastro/painel_de_controle/admin/{{ $campo->id }}/evento_clientes>Acessar-></a>
                  </div>
                      ...
                      <tbody>
                         @foreach($eventos as $evento)
                          <tr>
                            ...
                            <td><a href=\cadastro/painel_de_controle/admin/{{ $evento->id }}/evento_estatisticas>Estatísticas</a>
                            </td>
                            <td></td>
                            <td>
